    ...
    <>
      ...
      <div className="bg-image bg-cover">
        <div className=" flex w-11/12 mx-auto">
          ...
          {
            allActors?.map(actor => (
              <div key={actor.id} className="card border border-sky-400 text-white shadow-xl">
            ...
            <div className="card-body items-center text-center">
              <h2 className="text-3xl font-bold">{actor.name}</h2>
                ...
                <button onClick={() => handaleSelectActor(actor)} className="btn btn-primary">Contact Me</button>
                </div>
            </div>
            </div>
            ))
          ...
          <div className="w-1/3 ml-4 text-center pt-5">
            <h2 className="text-4xl underline text-black font-bold">
              Cart Section
            </h2>
          </div>
        </div>
